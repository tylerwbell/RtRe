...
function Make(Source) {
  ...
  var set = function (t, index, color) {
    var offset = (index << 2);
    Curry._3(Source.set, t.source, offset + 0 | 0, color.x | 0);
    Curry._3(Source.set, t.source, offset + 1 | 0, color.y | 0);
    return Curry._3(Source.set, t.source, offset + 2 | 0, color.z | 0);
  };
