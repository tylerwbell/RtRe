...
var Checkered$Rt = require("../../lib/Texture/Checkered.bs.js");
...
function render(camera, scene, context) {
  for(var x = 0; x <= 600; ++x){
    for(var y = 0; y <= 300; ++y){
      ...
      var color = match !== undefined ? match : Checkered$Rt.Texture.colorAt(Checkered$Rt.standard, {
              x: x / 600,
              y: y / 300
            });
...
/* Checkered-Rt Not a pure module */
