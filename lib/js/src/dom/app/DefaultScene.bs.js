...
var sky = /* LinearGradient */Block.__(1, [{
      ...
      aColor: Color$Rt.fromRgb(0.8, 1.0, 1.0),
      bColor: Color$Rt.fromRgb(0.8, 0.8, 1.0)
    }]);

function make(param) {
  var bodies = /* [] */0;
  for(var _for = 0; _for <= 200; ++_for){
    var a = Random.$$float(20.0) - 10.0;
    var b = Random.$$float(20.0) - 10.0;
