...
var RenderSettings$Rt = require("../../app/RenderSettings.bs.js");
...
function make(canvas) {
  ...
  var scheduler = RenderScheduler$Rt.make(settings, (function (slice) {
...
function dispatchRender(t) {
  ...
  RenderSlice$Rt.clear(t.compositor.rendering, Color$Rt.black);
